...
#   Then stop Mininet and inspect the contents of hangargames_output/($TOPOLOGY used
#   in run_alv.sh).
...
#   traffic from a pcap file then looking at the hangargames_output.
...
network_number = 192
k = args.k
p4_program = "../build/BMv2/ALV/ALV.json"
random.seed(0)
